...
const BEAUTY_PROMPT = `この画像から、美容院や床屋でカットしてもらうのに、美容師にこのヘアスタイルに近づけるように説明するためのカット方法や、前髪・横・後ろ・トップの髪の長さ、ツーブロックの有無、レイヤーの入れ方、毛量調整、セット方法、髪型の特徴などを、美容師さんに分かりやすく伝えるための説明文として書いてください。`;
